package Curdled.IMUInterleaving;
...
public class IMUInterleaving implements Feature {
	...
	private static hardwareMap;
	private static List<LynxModule> allHubs;
	public YawPitchRollAngles imuRead;

	private void getBulkRead(){ LynxModule.get(0).getBulkData(); }
	...
	public void postUserInitHook(@NotNull Wrapper opMode) {
		...
		hardwareMap = opMode.getOpMode().hardwareMap;
		llHubs = hardwareMap.getAll(LynxModule.class);
